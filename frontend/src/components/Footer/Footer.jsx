        ...
        <div className='max-w-7xl mx-auto relative z-10'>
                    ...
                    <form onSubmit={handleSubmit} className='relative mt-4 group'>
                        ...
                        <div className='relative'>
                            <input type="email" placeholder="Enter your email..." value={email}
                                ...
                                className='w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-2 border-amber-400/30 focus:outline-none focus:border-amber-400 focus:ring-4 focus:ring-amber-400/20 transition-all duration-300 placeholder-amber-200/50 pr-24 ' required />
                            <button type='submit' className='absolute right-1 top-1 bg-gradient-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition-all duration-500'>
                                ...
                                <BiChevronRight className='text-xl transition-transform duration-300 group-hover:animate-spin felx-shrink-0'/>
                        ...
                        <div className='flex space-x-4'>
                            {socialIcons.map(({icon: Icon, link, color, label}, idx)=>(
                                <a target='_blank' href={link} key={idx}
                                    className='text-2xl bg-amber-400/10 p-3 rounded-full hover:bg-amber-400/20 hover:scale transition-all duration-300 relative group' 
                                    style={{color}}>
                                    <Icon className='hover:scale-125 transition-transform' />
                                    <span className='absolute -bottom-8 left-1/2 -translate-x-1/2 bg-amber-400 text-black px-2 py-1 rounded text-xsx font-bold opacity-0 group-hover:opacity-100 transition-opacity'>
                                        {label}
                                    </span>
                                </a>
                            ))}
            ...
            <div className='border-t border-amber-800 pt-8 mt-8 text-center'>
                <p className='text-amber-400 text-lg mb-2 font-playfair'>
                    &copy; 2025 Foofy. All rights reserved.
                </p>
                <div className='group inline-block'>
                    <a href="##" target='_blank'  className='text-lg font-sacramento bg-gradient-to-r from-amber-400 via-amber-50 to-amber-400 bg-clip-text text-transparent hover:text-purple-300 transition-all duration-500'>
