...
const Navbar = () => {
  ...
  return (
    <nav className='bg-amber-900  border-b-8 border-amber-900/30 shadow-amber-900/30 sticky top-0 z-50 shadow-[0_25px-50px_-12px] font-vibes group/nav overflow-x-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-4 relative'>
            <div className='flex justify-between items-center h-16 md:h-20 lg:h-24'>
                ...
                <div className='flex-shrink-0 flex items-center space-x-2 group relative md:-translate-x-4 lg:-translate-x-6 ml-0 md:ml-2'>
                    ...
                    <GiChefToque className='text-3xl md:text-amber-500 transition-all group-hover:rotate-12 group-hover:text-amber-400 hover:drop-shadow-[0_0_15px] hover:drop-shadow-500/50' />
        ...
        {/* Mobile Navigation */}
        {isOpen && (
        <div className="md:hidden bg-amber-900  border-t-4 border-amber-900/40 relative shadow-lg shadow-amber-900/30 w-full">
        ...
        {showLoginModal && (
            <div className='fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4'>
                <div className='bg-gradient-to-br bg-amber-900 to-[#4a372a] rounded-xl p-6 w-full max-w-[480px] relative border-4 border-amber-700/30 shadow-[0_0_30px] shadow-amber-500/30'>
